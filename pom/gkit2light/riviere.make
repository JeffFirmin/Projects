...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/riviere
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/riviere
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/riviere
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/riviere
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/riviere
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/riviere
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/window.o: src/gKit/window.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/riviere.o: src/riviere.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
